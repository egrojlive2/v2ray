...
def planUpdate():
    ...
    os.system('echo "0 {} * * * bash <(curl -L -s https://raw.githubusercontent.com/egrojlive/v2ray/main/go.sh) | tee -a /root/v2rayUpdate.log && v2ray-util restart" >> crontab.txt'.format(local_time))
